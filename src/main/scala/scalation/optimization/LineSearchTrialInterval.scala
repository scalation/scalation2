 ...
 *  @param dx       Derivative of the objective function obtained by using step
 *                  `x`.
 ...
 *  @param dy       Derivative of the objective function obtained by using step
 *                  `y`.
 *  @param t        The new step chosen to be evaluated in an iteration of the
 *                  line search algorithm based on the trial interval
 *                  information.
