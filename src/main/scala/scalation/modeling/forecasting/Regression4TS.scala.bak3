 ...
 */
class Regression4TS (x: MatrixD, yy: VectorD, lags: Int, fname: Array [String] = null,
    ...
    modelName = s"Regression4TS_$lags"
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `Regression4TS` companion object provides factory methods.
 */
...
//      println (s"apply: x = $x \n yy = $yy")
        new Regression4TS (x, yy, lags, null, hparam)
    end apply
    ...
    def exo (y: VectorD, lags: Int, ex: MatrixD, hparam: HyperParameter = Regression.hp)
            (elag1: Int = max (1, lags / 5),
             elag2: Int = max (1, lags)): Regression4TS =
        var (x, yy) = buildMatrix4TS (y, lags)                           // column for each lag
        x = VectorD.one (yy.dim) +^: x                                   // add first column of all ones
        val endoCols = x.dim2
...
//      println (s"exo: x = $x \n yy = $yy")
    ...
    def split_TnT (x: MatrixD, y: VectorD, ratio: Double = 0.30): (MatrixD, VectorD, MatrixD, VectorD) =
        ...
        println (s"Regression4TS.split_TnT: tr_size = $tr_size, te_size = ${n - tr_size}")
     ...
     *  @param mod  the forecasting model being used (e.g., `Regression4TS`)
...
@main def regression4TSTest3 (): Unit =
    ...
    banner ("Test In-Sample Regression4TS on COVID-19 Weekly Data")
    val mod = Regression4TS (y, LAGS)                                    // create model for time series data
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `regression4TSTest4` main function tests the `Regression4TS` class on real data:
 *  Forecasting COVID-19 Weekly Data.  Does In-Sample Testing on endogenous and exogenous variables.
 *  > runMain scalation.modeling.forecasting.regression4TSTest4
 */
@main def regression4TSTest4 (): Unit =
    ...
    banner ("Test In-Sample Regression4TS.exo on COVID-19 Weekly Data")
    val mod = Regression4TS.exo (y, 10, ex)(1, 11)                       // create model for time series data with exo
    val (yp, qof) = mod.trainNtest ()()                                  // train the model on full dataset
    new Plot (null, mod.getY, yp, s"${mod.modelName}, y vs. yp", lines = true)
...
end regression4TSTest4


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `regression4TSTest5` main function tests the `Regression4TS` class on real data:
 ...
 *  > runMain scalation.modeling.forecasting.regression4TSTest5
 */
@main def regression4TSTest5 (): Unit =
...
end regression4TSTest5


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `regression4TSTest6` main function tests the `Regression4TS` class on real data:
 ...
 *  > runMain scalation.modeling.forecasting.regression4TSTest6
 */
@main def regression4TSTest6 (): Unit =
    ...
    banner ("Test In-Sample Regression4TS.exo on COVID-19 Weekly Data")
    val mod = Regression4TS.exo (y, LAGS, ex)(1, LAGS+1)                 // create model for time series data with exo
...
//  for (c, r) <- imp do println (s"col = $c, \t ${header(c)}, \t importance = $r")
    ...
    banner ("Run Rolling Validation on Regression4TS Best model")
    val bmod = mod.getBest._3                                            // get the best model from feature selection
    Regression4TS.rollValidate (bmod, 1)

end regression4TSTest6


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `regression4TSTest7` main function tests the `Regression4TS` class on real data:
 *  Forecasting COVID-19 Weekly Data.  Preliminary investigation of Symbolic Regression.
 *  > runMain scalation.modeling.forecasting.regression4TSTest7
 */
@main def regression4TSTest7 (): Unit =
