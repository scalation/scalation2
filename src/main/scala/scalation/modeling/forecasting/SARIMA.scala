 ...
 *
 *  @title   Model: Seasonal Auto-Regressive, Integrated, Moving Average (SARIMA)
 *
 ...
 *  θ is the moving-average coefficient vector, and e_t+1 is the noise vector.
 *------------------------------------------------------------------------------
