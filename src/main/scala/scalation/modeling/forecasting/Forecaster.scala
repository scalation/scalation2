...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** Compute the sum of squares errors, assume the first error is zero.
 *  @param y     the actual response vector
 *  @param yp    the predicted response vector (one-step ahead)
 *  @param skip  skip this many elements at the beginning
 */
 ...
 *  @param hparam  the hyper-parameters for the model extending this trait
 */
