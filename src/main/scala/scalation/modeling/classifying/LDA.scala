 ...
 */
class LDA (x: MatrixD, y: VectorI, fname_ : Array [String] = null, k: Int = 2,
    ...
    modelName = "LDA"                                                    // name of the model
    ...
    override def train (x_ : MatrixD = x, y_ : VectorI = y): Unit =
        val x1 = (MatrixD (for i <- x.indices if y_(i) == 0 yield x_(i))).transpose  // group 1
        val x2 = (MatrixD (for i <- x.indices if y_(i) == 1 yield x_(i))).transpose  // group 2
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `lDATest` main function is used to test the `LDA` class.
 *  @see people.revoledu.com/kardi/tutorial/LDA/Numerical%20Example.html
 *  > runMain scalation.modeling.classifying.lDATest
 */
@main def lDATest (): Unit =
    ...
    val lda = new LDA (x, y, fname, 2, cname)                     // create the LDA classifier
